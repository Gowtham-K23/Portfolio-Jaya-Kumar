...
const Tools = () => {
  return (
    <motion.div className='bg-white pb-20'
        ...
        <h2 className='text-4xl font-bold font-poppins text-center pt-14 pb-5 text-button_color'>The Gear I Work With</h2>
        
        <div className='grid grid-cols:1 sm:grid-cols-3 lg:grid-cols-3 gap-8 mt-12 px-4 md:px-20'>
        
          <div className = 'flex flex-col items-center bg-pink-300 p-6 rounded-full shadow-lg hover:shadow-2xl hover:bg-text_primary hover:text-white duration-500 text-black'>
